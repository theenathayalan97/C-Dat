...
router.post("/login",  awsController.userLogin);
...
router.post("/organization_signup", middleware.authorization, middleware.authentication(['superAdmin'],true), awsController.organizationSignUp);
